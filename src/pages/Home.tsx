    ...
    <Layout>
        ...
        <div className="container-ngo">
          <div className="text-center mb-12">
            ...
            <p className="text-lead max-w-2xl mx-auto">
              Communities across Nigeria face interconnected psychosocial, environmental, 
              and social challenges that threaten wellbeing, dignity, and sustainable development.
            </p>
          </div>
        ...
        <div className="container-ngo">
          <div className="text-center mb-12">
            ...
            <p className="text-lead max-w-2xl mx-auto">
              ...
              the root causes of psychosocial distress and build lasting resilience.
            </p>
          </div>
        ...
        <div className="container-ngo">
          <div className="text-center mb-12">
            ...
            <p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto">
              Figures will be updated as programs expand. Every number represents 
              a life touched, a community strengthened.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Button variant="hero" size="lg" asChild>
              <Link to="/impact">See Our Projects</Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lead mb-6">
                Our approach prioritizes local ownership, participation, and inclusion. 
                We believe lasting change comes from within communities, with external 
                support serving as a catalyst rather than a solution.
              </p>
      ...
      <section className="section-padding">
        <div className="container-ngo">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link to="/resources#mental-health" className="card-ngo p-6 group">
              <BookOpen className="h-8 w-8 text-primary mb-4" />
              <h3 className="heading-card mb-2 group-hover:text-primary transition-colors">
                Mental Health Resources
              </h3>
              <p className="text-muted-foreground text-sm">
                Guides and information on mental health awareness and support.
              </p>
            </Link>
            <Link to="/resources#guides" className="card-ngo p-6 group">
              <Users className="h-8 w-8 text-primary mb-4" />
              <h3 className="heading-card mb-2 group-hover:text-primary transition-colors">
                Community Guides
              </h3>
              <p className="text-muted-foreground text-sm">
                Practical resources for community leaders and facilitators.
              </p>
            </Link>
            <Link to="/resources#publications" className="card-ngo p-6 group">
              <FileText className="h-8 w-8 text-primary mb-4" />
              <h3 className="heading-card mb-2 group-hover:text-primary transition-colors">
                Reports & Publications
              </h3>
              <p className="text-muted-foreground text-sm">
                Research, reports, and publications from our work.
              </p>
            </Link>
          </div>
        </div>
