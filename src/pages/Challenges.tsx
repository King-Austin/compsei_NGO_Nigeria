        ...
        <div className="container-ngo">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lead">
              These challenges are deeply interconnected. Mental health affects community 
              resilience, climate change exacerbates psychosocial distress, and environmental 
              degradation undermines the foundation of community wellbeing. Addressing them 
                  ...
                  <div className="bg-muted rounded-2xl p-8 h-full flex items-center justify-center min-h-[300px]">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground text-sm italic">
                        Field Project Image – {challenge.title}<br />
                        (To Be Updated)
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-secondary">
        <div className="container-ngo text-center">
          ...
          <p className="text-secondary-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
            Learn about our programs designed to address these interconnected challenges 
