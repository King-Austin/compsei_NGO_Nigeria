          ...
          <div className="space-y-20">
            ...
            <div id="partner" className="scroll-mt-24">
              <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="lg:order-1 bg-muted rounded-2xl p-8">
            ...
            <div id="donate" className="scroll-mt-24">
              <div className="card-ngo p-8 md:p-12 bg-gradient-subtle">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <div className="mb-8">
                    <h3 className="font-semibold mb-6">Your Support Enables Us To:</h3>
