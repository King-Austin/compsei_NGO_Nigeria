...
const WHATSAPP_NUMBER = "2348102522048";
...
export function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const messageText =
      `*New Message from COMPSEI Website*\n\n` +
      `*Name:* ${formData.name}\n` +
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <Input id="subject" name="subject" type="text" placeholder="How can we help?" value={formData.subject} onChange={handleChange} required />
      </div>
      <div>
