...
export const metadata: Metadata = {
  ...
  description:
    "See the measurable community impact of COMPSEI's programs — over 15 communities reached, 500+ individuals supported, and 10+ projects implemented across Nigeria.",
  openGraph: {
    title: "Impact & Projects | COMPSEI",
    url: "https://compsei.com.ng/impact",
    images: [{ url: "/compsei-logo.png", width: 512, height: 512, alt: "COMPSEI Impact & Projects" }],
  },
  alternates: { canonical: "https://compsei.com.ng/impact" },
};
...
const projects = [
  ...
  },
  {
    ...
    image: "/images/volunteer-group.png",
  },
  {
...
const gallery = [
  { image: "/images/community-engagement.png", title: "Community Training" },
  { image: "/images/tree-planting.jpg", title: "Tree Planting Activity" },
  { image: "/images/counselling-session.png", title: "Support Session" },
  { image: "/images/youth-empowerment.png", title: "Youth Workshop" },
  { image: "/images/volunteer-group.png", title: "Volunteer Team" },
  { image: "/images/community-dialogue.png", title: "Community Dialogue" },
];
    ...
    <>
        ...
        <div className="container-ngo">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed">
              Every number represents a life touched, a community strengthened, and a step toward
      ...
      <section className="py-16 bg-muted">
        <div className="container-ngo">
          ...
          <p className="text-center text-sm text-muted-foreground mt-8 italic">* Figures will be updated as programs expand</p>
        </div>
      </section>
        ...
        <div className="container-ngo">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lead">
              Our projects are characterized by participation, inclusion, and local ownership. We believe
              sustainable impact comes from working with communities, not for them. Every intervention is
              designed collaboratively, implemented with local leadership, and evaluated with community input.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-muted">
        <div className="container-ngo">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1.5 bg-secondary/20 text-secondary-foreground text-sm font-medium rounded-full mb-4">Our Projects</span>
      ...
      <section className="section-padding">
        <div className="container-ngo">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1.5 bg-primary/10 text-primary text-sm font-medium rounded-full mb-4">Photo Gallery</span>
      ...
      <section className="py-16 bg-secondary">
        <div className="container-ngo text-center">
          <h2 className="heading-section text-secondary-foreground mb-4">Be Part of Our Impact Story</h2>
          <p className="text-secondary-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
            Partner with us or support our work to expand our reach and deepen our impact in communities across Nigeria.
          </p>
